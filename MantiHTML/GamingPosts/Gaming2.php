<?php
    $error= '';
    $str=file_get_contents('GamingTitle2.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Gaming2.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/GamingPosts/GamingData2.json", function(obj){
