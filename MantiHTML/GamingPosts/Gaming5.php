<?php
    $error= '';
    $str=file_get_contents('GamingTitle5.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Gaming5.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/GamingPosts/GamingData5.json", function(obj){
