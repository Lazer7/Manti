<?php
    $error= '';
    $str=file_get_contents('GamingTitle4.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Gaming4.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/GamingPosts/GamingData4.json", function(obj){
