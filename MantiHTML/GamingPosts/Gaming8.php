<?php
    $error= '';
    $str=file_get_contents('GamingTitle8.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Gaming8.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/GamingPosts/GamingData8.json", function(obj){
