<?php
    $error= '';
    $str=file_get_contents('GamingTitle1.json'); //changes here
    ...
    if(isset($_POST['submit2'])){
        ...
        unset($_POST);
        $conn->close();
        header("Location: Gaming1.php");  //changes here
        }
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            <!--This contains all the comments changes here-->
            <form name="form" Method="POST" action="Gaming1.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/GamingPosts/GamingData1.json", function(obj){
                ...
                $.each(obj, function(key,value){
                 ...
                 $("#FillTitle").tmpl(titles).appendTo("#Titles");
                    ...
                    //changes here
            $.getJSON("../../MantiHTML/GamingPosts/comments.json", function(obj){
                $.each(obj, function(key,value){
