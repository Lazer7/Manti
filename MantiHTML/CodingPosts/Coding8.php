<?php
    $error= '';
    $str=file_get_contents('CodingTitle8.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Coding8.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/CodingPosts/CodingData8.json", function(obj){
