<?php
    $error= '';
    $str=file_get_contents('CodingTitle3.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Coding3.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/CodingPosts/CodingData3.json", function(obj){
