<?php
    $error= '';
    $str=file_get_contents('CodingTitle6.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Coding6.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/CodingPosts/CodingData6.json", function(obj){
