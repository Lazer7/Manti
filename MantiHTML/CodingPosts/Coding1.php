<?php
    $error= '';
    $str=file_get_contents('CodingTitle1.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Coding1.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/CodingPosts/CodingData1.json", function(obj){
            ...
            $.getJSON("../../MantiHTML/CodingPosts/comments.json", function(obj){
                $.each(obj, function(key,value){
