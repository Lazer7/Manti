<?php
    $error= '';
    $str=file_get_contents('CodingTitle4.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Coding4.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/CodingPosts/CodingData4.json", function(obj){
