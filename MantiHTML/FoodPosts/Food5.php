<?php
    $error= '';
    $str=file_get_contents('FoodTitle5.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Food5.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/FoodPosts/FoodData5.json", function(obj){
