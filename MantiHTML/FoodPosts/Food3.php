<?php
    $error= '';
    $str=file_get_contents('FoodTitle3.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Food3.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/FoodPosts/FoodData3.json", function(obj){
