<?php
    $error= '';
    $str=file_get_contents('FoodTitle6.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Food6.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/FoodPosts/FoodData6.json", function(obj){
