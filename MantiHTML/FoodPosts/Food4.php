<?php
    $error= '';
    $str=file_get_contents('FoodTitle4.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Food4.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/FoodPosts/FoodData4.json", function(obj){
