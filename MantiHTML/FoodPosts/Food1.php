<?php
    $error= '';
    $str=file_get_contents('FoodTitle1.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Food1.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/FoodPosts/FoodData1.json", function(obj){
            ...
            $.getJSON("../../MantiHTML/FoodPosts/comments.json", function(obj){
                $.each(obj, function(key,value){
