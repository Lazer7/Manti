<?php
    $error= '';
    $str=file_get_contents('CodingHelpTitle8.json');
    ...
    if(isset($_POST['submit2'])){
        ...
        unset($_POST);
        $conn->close();
        header("Location: CodingHelp8.php");  
        }
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="CodingHelp8.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/CodingHelpPosts/CodingHelpData8.json", function(obj){
