<?php
    $error= '';
    $str=file_get_contents('CodingHelpTitle1.json');
 ...
 $Comments.='{"Comment_ID":'.$row['CommentID'].','.'"Comment_message":'.'"'.$row['Comment_message'].'"'.','.'"Comment_Date":'.'"'.$row['Comment_Date'].'"'.','.'"Comment_Rating":"'.$ratings[$index].'"},';
    ...
    if(isset($_POST['submit2'])){
        ...
        unset($_POST);
        $conn->close();
        header("Location: CodingHelp1.php");  
        }
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="CodingHelp1.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/CodingHelpPosts/CodingHelpData1.json", function(obj){
            ...
            $.getJSON("../../MantiHTML/CodingHelpPosts/comments.json", function(obj){
                $.each(obj, function(key,value){
