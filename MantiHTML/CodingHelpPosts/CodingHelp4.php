<?php
    $error= '';
    $str=file_get_contents('CodingHelpTitle4.json');
    ...
    if(isset($_POST['submit2'])){
        ...
        unset($_POST);
        $conn->close();
        header("Location: CodingHelp4.php");  
        }
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="CodingHelp4.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/CodingHelpPosts/CodingHelpData4.json", function(obj){
