<?php
    $error= '';
    $str=file_get_contents('CodingHelpTitle6.json');
    ...
    if(isset($_POST['submit2'])){
        ...
        unset($_POST);
        $conn->close();
        header("Location: CodingHelp6.php");  
        }
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="CodingHelp6.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/CodingHelpPosts/CodingHelpData6.json", function(obj){
