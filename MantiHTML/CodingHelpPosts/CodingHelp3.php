<?php
    $error= '';
    $str=file_get_contents('CodingHelpTitle3.json');
    ...
    if(isset($_POST['submit2'])){
        ...
        unset($_POST);
        $conn->close();
        header("Location: CodingHelp3.php");  
        }
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="CodingHelp3.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/CodingHelpPosts/CodingHelpData3.json", function(obj){
