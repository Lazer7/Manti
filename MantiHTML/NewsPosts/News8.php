<?php
    $error= '';
    $str=file_get_contents('NewsTitle8.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="News8.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/NewsPosts/NewsData8.json", function(obj){
