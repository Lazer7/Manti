<?php
    $error= '';
    $str=file_get_contents('NewsTitle2.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="News2.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/NewsPosts/NewsData2.json", function(obj){
