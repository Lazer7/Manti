<?php
    $error= '';
    $str=file_get_contents('NewsTitle5.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="News5.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/NewsPosts/NewsData5.json", function(obj){
