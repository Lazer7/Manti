<?php
    $error= '';
    $str=file_get_contents('NewsTitle10.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="News10.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/NewsPosts/NewsData10.json", function(obj){
