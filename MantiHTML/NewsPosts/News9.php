<?php
    $error= '';
    $str=file_get_contents('NewsTitle9.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="News9.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/NewsPosts/NewsData9.json", function(obj){
