<?php
    $error= '';
    $str=file_get_contents('AnimeTitle8.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Anime8.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/AnimePosts/AnimeData8.json", function(obj){
