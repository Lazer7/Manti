<?php
    $error= '';
    $str=file_get_contents('AnimeTitle6.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Anime6.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/AnimePosts/AnimeData6.json", function(obj){
