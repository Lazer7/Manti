<?php
    $error= '';
    $str=file_get_contents('AnimeTitle10.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Anime10.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/AnimePosts/AnimeData10.json", function(obj){
