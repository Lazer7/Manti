<?php
    $error= '';
    $str=file_get_contents('AnimeTitle2.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Anime2.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/AnimePosts/AnimeData2.json", function(obj){
