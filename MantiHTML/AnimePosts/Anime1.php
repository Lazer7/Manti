...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Anime1.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/AnimePosts/AnimeData1.json", function(obj){
            ...
            $.getJSON("../../MantiHTML/AnimePosts/comments.json", function(obj){
                $.each(obj, function(key,value){
