<?php
    $error= '';
    $str=file_get_contents('ScienceAndTechnologyTitle8.json');
    ...
    if(isset($_POST['submit2'])){
        ...
        unset($_POST);
        $conn->close();
        header("Location: ScienceAndTechnology8.php");  
        }
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="ScienceAndTechnology8.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/ScienceAndTechnologyPosts/ScienceAndTechnologyData8.json", function(obj){
