<?php
    $error= '';
    $str=file_get_contents('ScienceAndTechnologyTitle9.json');
    ...
    if(isset($_POST['submit2'])){
        ...
        unset($_POST);
        $conn->close();
        header("Location: ScienceAndTechnology9.php");  
        }
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="ScienceAndTechnology9.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/ScienceAndTechnologyPosts/ScienceAndTechnologyData9.json", function(obj){
