<?php
    $error= '';
    $str=file_get_contents('ScienceAndTechnologyTitle5.json');
    ...
    if(isset($_POST['submit2'])){
        ...
        unset($_POST);
        $conn->close();
        header("Location: ScienceAndTechnology5.php");  
        }
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="ScienceAndTechnology5.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/ScienceAndTechnologyPosts/ScienceAndTechnologyData5.json", function(obj){
