<?php
    $error= '';
    $str=file_get_contents('ScienceAndTechnologyTitle3.json');
    ...
    if(isset($_POST['submit2'])){
        ...
        unset($_POST);
        $conn->close();
        header("Location: ScienceAndTechnology3.php");  
        }
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="ScienceAndTechnology3.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/ScienceAndTechnologyPosts/ScienceAndTechnologyData3.json", function(obj){
