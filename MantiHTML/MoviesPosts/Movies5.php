<?php
    $error= '';
    $str=file_get_contents('MoviesTitle5.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Movies5.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/MoviesPosts/MoviesData5.json", function(obj){
