<?php
    $error= '';
    $str=file_get_contents('MoviesTitle1.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Movies1.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/MoviesPosts/MoviesData1.json", function(obj){
