<?php
    $error= '';
    $str=file_get_contents('MoviesTitle6.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Movies6.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/MoviesPosts/MoviesData6.json", function(obj){
