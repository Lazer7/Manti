<?php
    $error= '';
    $str=file_get_contents('MoviesTitle7.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Movies7.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/MoviesPosts/MoviesData7.json", function(obj){
