<?php
    $error= '';
    $str=file_get_contents('MoviesTitle10.json');
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Movies10.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/MoviesPosts/MoviesData10.json", function(obj){
            ...
            $.getJSON("../../MantiHTML/MoviesPosts/comments.json", function(obj){
                $.each(obj, function(key,value){
