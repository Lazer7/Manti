<?php
    $error= '';
    $str=file_get_contents('PhilosophyTitle4.json');
    ...
    if(isset($_POST['submit2'])){
        ...
        unset($_POST);
        $conn->close();
        header("Location: Philosophy4.php");  
        }
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Philosophy4.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/PhilosophyPosts/PhilosophyData4.json", function(obj){
