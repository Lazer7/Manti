<?php
    $error= '';
    $str=file_get_contents('PhilosophyTitle6.json');
    ...
    if(isset($_POST['submit2'])){
        ...
        unset($_POST);
        $conn->close();
        header("Location: Philosophy6.php");  
        }
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Philosophy6.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/PhilosophyPosts/PhilosophyData6.json", function(obj){
