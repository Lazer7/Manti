<?php
    $error= '';
    $str=file_get_contents('PhilosophyTitle8.json');
    ...
    if(isset($_POST['submit2'])){
        ...
        unset($_POST);
        $conn->close();
        header("Location: Philosophy8.php");  
        }
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Philosophy8.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/PhilosophyPosts/PhilosophyData8.json", function(obj){
