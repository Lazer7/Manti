<?php
    $error= '';
    $str=file_get_contents('PhilosophyTitle3.json');
    ...
    if(isset($_POST['submit2'])){
        ...
        unset($_POST);
        $conn->close();
        header("Location: Philosophy3.php");  
        }
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Philosophy3.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/PhilosophyPosts/PhilosophyData3.json", function(obj){
