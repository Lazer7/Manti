<?php
    $error= '';
    $str=file_get_contents('PhilosophyTitle9.json');
    ...
    if(isset($_POST['submit2'])){
        ...
        unset($_POST);
        $conn->close();
        header("Location: Philosophy9.php");  
        }
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Philosophy9.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/PhilosophyPosts/PhilosophyData9.json", function(obj){
