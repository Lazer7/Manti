<?php
    $error= '';
    $str=file_get_contents('PhilosophyTitle10.json');
    ...
    if(isset($_POST['submit2'])){
        ...
        unset($_POST);
        $conn->close();
        header("Location: Philosophy10.php");  
        }
...
<!DOCTYPE html>
    <html>
        ...
        <body>
            ...
            <form name="form" Method="POST" action="Philosophy10.php" style="width: 100%">
            <div id="pageContent">
            ...
            $.getJSON("../../MantiHTML/PhilosophyPosts/PhilosophyData10.json", function(obj){
            ...
            $.getJSON("../../MantiHTML/PhilosophyPosts/comments.json", function(obj){
                $.each(obj, function(key,value){
