...
document.getElementById('post1').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/NewsPosts/News1.php";
...
document.getElementById('post2').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/NewsPosts/News2.php";
}
...
document.getElementById('post3').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/NewsPosts/News3.php";
}
...
document.getElementById('post4').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/NewsPosts/News4.php";
}
...
document.getElementById('post5').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/NewsPosts/News5.php";
}
...
document.getElementById('post6').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/NewsPosts/News6.php";
}
...
document.getElementById('post7').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/NewsPosts/News7.php";
}
...
document.getElementById('post8').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/NewsPosts/News8.php";
}
...
document.getElementById('post9').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/NewsPosts/News9.php";
}
...
document.getElementById('post10').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/NewsPosts/News10.php";
}