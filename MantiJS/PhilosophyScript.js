...
document.getElementById('post1').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/PhilosophyPosts/Philosophy1.php";
...
document.getElementById('post2').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/PhilosophyPosts/Philosophy2.php";
}
...
document.getElementById('post3').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/PhilosophyPosts/Philosophy3.php";
}
...
document.getElementById('post4').onclick = function(){
    ...
    type = document.getElementById('date4').getAttribute('type');
     window.location = "http://localhost/Manti/MantiHtml/PhilosophyPosts/Philosophy4.php";
}
...
document.getElementById('post5').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/PhilosophyPosts/Philosophy5.php";
}
...
window.location = "http://localhost/Manti/MantiHtml/PhilosophyPosts/Philosophy6.php";
}
...
window.location = "http://localhost/Manti/MantiHtml/PhilosophyPosts/Philosophy7.php";
}
...
window.location = "http://localhost/Manti/MantiHtml/PhilosophyPosts/Philosophy8.php";
}
...
window.location = "http://localhost/Manti/MantiHtml/PhilosophyPosts/Philosophy9.php";
}
...
window.location = "http://localhost/Manti/MantiHtml/PhilosophyPosts/Philosophy10.php";
}