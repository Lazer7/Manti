...
document.getElementById('post1').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/ScienceAndTechnologyPosts/ScienceAndTechnology1.php";
...
document.getElementById('post2').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/ScienceAndTechnologyPosts/ScienceAndTechnology2.php";
}
...
document.getElementById('post3').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/ScienceAndTechnologyPosts/ScienceAndTechnology3.php";
}
...
document.getElementById('post4').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/ScienceAndTechnologyPosts/ScienceAndTechnology4.php";
}
...
document.getElementById('post5').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/ScienceAndTechnologyPosts/ScienceAndTechnology5.php";
}
...
document.getElementById('post6').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/ScienceAndTechnologyPosts/ScienceAndTechnology6.php";
}
...
document.getElementById('post7').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/ScienceAndTechnologyPosts/ScienceAndTechnology7.php";
}
...
document.getElementById('post8').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/ScienceAndTechnologyPosts/ScienceAndTechnology8.php";
}
...
document.getElementById('post9').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/ScienceAndTechnologyPosts/ScienceAndTechnology9.php";
}
...
document.getElementById('post10').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/ScienceAndTechnologyPosts/ScienceAndTechnology10.php";
}