...
document.getElementById('post1').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/GamingPosts/Gaming1.php";
...
document.getElementById('post2').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/GamingPosts/Gaming2.php";
}
...
document.getElementById('post3').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/GamingPosts/Gaming3.php";
}
...
document.getElementById('post4').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/GamingPosts/Gaming4.php";
}
...
document.getElementById('post5').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/GamingPosts/Gaming5.php";
}
...
document.getElementById('post6').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/GamingPosts/Gaming6.php";
}
...
document.getElementById('post7').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/GamingPosts/Gaming7.php";
}
...
document.getElementById('post8').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/GamingPosts/Gaming8.php";
}
...
document.getElementById('post9').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/GamingPosts/Gaming9.php";
}
...
document.getElementById('post10').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/GamingPosts/Gaming10.php";
}