...
document.getElementById('post1').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/MoviesPosts/Movies1.php";
...
document.getElementById('post2').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/MoviesPosts/Movies2.php";
}
...
document.getElementById('post3').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/MoviesPosts/Movies3.php";
}
...
document.getElementById('post4').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/MoviesPosts/Movies4.php";
}
...
document.getElementById('post5').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/MoviesPosts/Movies5.php";
}
...
document.getElementById('post6').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/MoviesPosts/Movies6.php";
}
...
document.getElementById('post7').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/MoviesPosts/Movies7.php";
}
...
document.getElementById('post8').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/MoviesPosts/Movies8.php";
}
...
document.getElementById('post9').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/MoviesPosts/Movies9.php";
}
...
document.getElementById('post10').onclick = function(){
    ...
    window.location = "http://localhost/Manti/MantiHtml/MoviesPosts/Movies10.php";
}